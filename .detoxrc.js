...
module.exports = {
  ...
  apps: {
    'ios.debug': {
      type: 'ios.app',
      binaryPath: '~/Library/Developer/Xcode/DerivedData',
      build:
        'xcodebuild -workspace ios/nikahpro.xcworkspace -scheme nikahpro -configuration Debug -sdk iphonesimulator -derivedDataPath ios/build',
    },
    'ios.release': {
      type: 'ios.app',
      binaryPath:
